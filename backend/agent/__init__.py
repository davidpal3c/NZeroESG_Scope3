...
from agent.tools import emissions_tool, supplier_tool, compare_shipping_emissions, distance_tool
...
async def build_agent():
    tools = [emissions_tool, supplier_tool, compare_shipping_emissions, distance_tool]
    llm = load_llm()
