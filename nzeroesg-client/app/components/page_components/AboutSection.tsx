            ...
            <div className="max-w-5xl mx-auto px-6 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left text-sm max-w-4xl mx-auto">
                    ...
                    <FadeInWhenVisible delay={0.3}>
                        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
                            <h4 className="text-lg font-semibold text-accent mb-2">🧠 Agentic AI at Work</h4>
                            <p className="text-muted-foreground">
                    ...
                    <FadeInWhenVisible delay={0.4}>
                        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
                            <h4 className="text-lg font-semibold text-accent mb-2">🔮 Built for What’s Next</h4>
                            <p className="text-muted-foreground">
                    ...
                    <FadeInWhenVisible delay={0.5}>
                        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
                            <h4 className="text-lg font-semibold text-accent mb-2">🚧 Under Construction - Actively Evolving</h4>
                            <p className="text-muted-foreground">
